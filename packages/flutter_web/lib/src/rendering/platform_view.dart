...
/// A render object for an HTML view.
///
/// [RenderHtmlView] is responsible for sizing and displaying an HTML element.
///
/// {@macro flutter.rendering.platformView.layout}
///
/// See also:
///
/// * [HtmlView] which is a widget which is used to show an HTML element.
/// * [PlatformViewsService] which is a service for controlling platform views.
class RenderHtmlView extends RenderBox {
  /// Creates a render object for an HTML view.
  RenderHtmlView({
    @required HtmlViewController viewController,
  }) : assert(viewController != null),
       _viewController = viewController {
    _viewController.addOnPlatformViewCreatedListener(_onPlatformViewCreated);
  }
  ...
  /// The HTML view controller for the HTML view associated with this render object.
  HtmlViewController get viewController => _viewController;
  HtmlViewController _viewController;

  /// Sets a new HTML view controller.
  ///
  /// `viewController` must not be null.
  set viewController(HtmlViewController viewController) {
    assert(_viewController != null);
    assert(viewController != null);
    if (_viewController == viewController)
      return;
