...
class FlutterLogoDecoration extends Decoration {
  ...
  int get hashCode {
    assert(debugAssertIsValid());
    return hashValues(lightColor, darkColor, textColor, _position, _opacity);
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    if (_inTransition)
      properties
          .add(DiagnosticsNode.message('transition $_position:$_opacity'));
  }
}
      ...
      if (_config._position > 0.0) {
        ...
        canvas.translate(
            logoTargetSquare.center.dx -
                (_textBoundingRect.width * scale / 2.0),
